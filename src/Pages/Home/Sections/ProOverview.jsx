...
const ProOverview = () => {
  return (
    <div className="container px-0 2xl:px-12 2xl:w-11/12 grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-8 pt-20">
      {ProjectsList.map((item) => (
        ...
        >
          <div className="w-full h-16 flex items-center justify-start ">
            <img src={item.img} alt="" className="object-cover py-1" />
          </div>
