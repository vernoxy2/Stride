...
const PrimaryAmenities = ({ data = [] }) => {
  return (
    <div className="container space-y-4 md:space-y-8">
      ...
      <div className="grid  grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 gap-y-12 py-14">
        {data.map((item) => (
          <div
          data-aos="zoom-in"
            key={item.id}
          ...
          >
            <div className="bg-secondary w-fit p-4 rounded-full -mt-14 group-hover:bg-stride duration-300 border-8 border-bg transition-colors">
